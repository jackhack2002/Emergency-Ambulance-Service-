...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
                ...
                rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            Toast.makeText(MainActivity.this, "ELSE Refreshing", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void LogOutDriver() {
        Intent welcomeIntent=new Intent(MainActivity.this,MainActivity.class);
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                resolvableApiException
                                        .startResolutionForResult(MainActivity.this,Request_User_Location_Code);
