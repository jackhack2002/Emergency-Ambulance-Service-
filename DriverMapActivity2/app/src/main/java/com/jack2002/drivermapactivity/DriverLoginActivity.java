package com.jack2002.drivermapactivity;
...
public class DriverLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                else if(!(email.isEmpty() && password.isEmpty()))
                {
                    ...
                    mfirebaseauth.signInWithEmailAndPassword(email,password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            {
                                progressDialog.dismiss();
                                startActivity(new Intent(DriverLoginActivity.this,AddAmbulances.class));
                                finish();
                            }
                        }
                    });
        ...
        tvregister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DriverLoginActivity.this, DriverLoginActivity.class);
                startActivity(i);
            }
        });
        ...
        tvforgotpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DriverLoginActivity.this,Forgot_password_Activity.class);
